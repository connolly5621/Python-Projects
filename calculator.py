...
# ! This is meant for fun and is vulnerable to malicious code
...
btn_0 = tk.Button(root, text="0", command=lambda: add_to_calculation(9), width=5, font=("Calibri", 14))
...
btn_mult = tk.Button(root, text="*", command=lambda: add_to_calculation("*"), width=5, font=("Calibri", 14))
btn_mult.grid(row=4, column=4)
btn_div = tk.Button(root, text="/", command=lambda: add_to_calculation("/"), width=5, font=("Calibri", 14))
...
btn_equals = tk.Button(root, text="=", command=evaluate_calculation, width=12, font=("Calibri", 14))
btn_equals.grid(row=6, column=3, columnspan=2)
btn_clear = tk.Button(root, text="clear", command=clear_field, width=12, font=("Calibri", 14))
